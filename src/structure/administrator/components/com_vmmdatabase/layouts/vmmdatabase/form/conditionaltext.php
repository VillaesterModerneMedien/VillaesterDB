 ...
 * @var   string   $formel      The text to use in a bootstrap input group append
 */

$bezugsfeldStart = strpos($formel,'{',0);
$bezugsfeld = substr($formel, $bezugsfeldStart + 1);
//var_dump($bezugsfeld);
$bezugsfeldEnde = strpos($bezugsfeld,'}', 0);
$bezugsfeld = substr($bezugsfeld, 0, $bezugsfeldEnde );

$formelLength = strlen($formel);

$formelJS = str_replace('{' . $bezugsfeld . '}', 'bezugswert', $formel);

//var_dump($bezugsfeld);
//var_dump($formelScriptStart);
//var_dump($formelScriptEnd);
//var_dump($formel);
//var_dump($formelJS);
...
<script>
    $(function() {
        $('#jform_<?= $bezugsfeld; ?>').on('change', function(e){
            var bezugswert = parseInt($(this).val());
            var formelErgebnis = eval(<?= $formelJS; ?>);
            $('#<?= $id; ?>').val(formelErgebnis);
        })
    });
