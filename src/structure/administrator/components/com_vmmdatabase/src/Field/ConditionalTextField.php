...
namespace CustomerNamespace\Component\Vmmdatabase\Administrator\Field;
 ...
 * @since  1.7.0
 */
class ConditionalTextField extends FormField
{
    /**
     * The form field type.
     *
     ...
     * @since  1.7.0
     */
    protected $type = 'ConditionalText';
     ...
     * @since  3.7
     */
    protected $layout = 'vmmdatabase.form.conditionaltext';
    ...
    public function setup(\SimpleXMLElement $element, $value, $group = null)
    {
        ...
        if ($result == true)
        {
            ...
            $formel = (string) $this->element['formel'];
