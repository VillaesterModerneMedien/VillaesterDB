...
namespace CustomerNamespace\Component\Vmmdatabase\Administrator\View\Customer;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title($isNew ? Text::_('COM_VMMDATABASE_CUSTOMER_NEW') : Text::_('COM_VMMDATABASE_CUSTOMER_EDIT'), 'address customer');
		...
		if ($isNew) {
			...
			if ($isNew && (count($user->getAuthorisedCategories('com_vmmdatabase', 'core.create')) > 0)) {
				ToolbarHelper::apply('customer.apply');
				ToolbarHelper::saveGroup(
					[
						['save', 'customer.save'],
						['save2new', 'customer.save2new']
					],
					'btn-success'
				);
			}
