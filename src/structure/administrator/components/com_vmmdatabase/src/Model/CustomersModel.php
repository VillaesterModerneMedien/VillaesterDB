...
class CustomersModel extends ListModel
{
    ...
    protected function getListQuery()
    {
        ...
        $query->from($db->quoteName('#__vmmdatabase_details', 'a'));
            ...
            $subQuery = $db->getQuery(true)
                ...
                ->where(
                    [
                        ...
                        $db->quoteName('asso1.context') . ' = ' . $db->quote('com_vmmdatabase.item'),
                    ]
                );
            ...
            $subQuery = $db->getQuery(true)
                ...
                ->where(
                    [
                        ...
                        $db->quoteName('type_alias') . ' = ' . $db->quote('com_vmmdatabase.customer'),
                    ]
                );
            ...
            $query->join(
                ...
                ->where(
                    [
                        ...
                        $db->quoteName('tagmap.type_alias') . ' = ' . $db->quote('com_vmmdatabase.customer'),
                    ]
                )
