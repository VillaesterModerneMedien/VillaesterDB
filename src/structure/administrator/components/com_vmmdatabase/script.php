...
/**
 * Script file of Customer Component
 *
 * @since  __BUMP_VERSION__
 */
class Com_vmmdatabaseInstallerScript extends InstallerScript
{
	/**
	...
	{
		echo Text::_('COM_VMMDATABASE_INSTALLERSCRIPT_INSTALL');

		$db = Factory::getDbo();
		$alias   = ApplicationHelper::stringURLSafe('CustomerUncategorised');
		...
		$this->addDashboardMenu('vmmdatabase', 'vmmdatabase');
	...
	{
		echo Text::_('COM_VMMDATABASE_INSTALLERSCRIPT_UNINSTALL');
	...
	{
		echo Text::_('COM_VMMDATABASE_INSTALLERSCRIPT_UPDATE');

		$this->addDashboardMenu('customer', 'customer');
	...
	public function preflight($type, $parent): bool
	{
		...
		echo Text::_('COM_VMMDATABASE_INSTALLERSCRIPT_PREFLIGHT');
	...
	{
		echo Text::_('COM_VMMDATABASE_INSTALLERSCRIPT_POSTFLIGHT');
	...
	private function saveContentTypes()
	{
		...
		$table->load(['type_alias' => 'com_vmmdatabase.customer']);

		$tablestring = '{
			"special": {
			  "dbtable": "#__vmmdatabase",
			  "key": "id",
			  "type": "CustomerTable",
			  "prefix": "CustomerNamespace\\\\Component\\\\Vmmdatabase\\\\Administrator\\\\Table\\\\",
			  "config": "array()"
			},
			"common": {
		...
		$contenttype['type_title'] = 'Vmmdatabase';
		$contenttype['type_alias'] = 'com_vmmdatabase.customer';
		$contenttype['table'] = $tablestring;
		$contenttype['rules'] = '';
		$contenttype['router'] = 'RouteHelper::getCustomerRoute';
