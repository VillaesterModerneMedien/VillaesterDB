...
namespace CustomerNamespace\Component\Vmmdatabase\Site\View\Category;
...
/**
 * HTML View class for the Vmmdatabase component
 *
...
class HtmlView extends CategoryView
{
	 ...
	 * @since  __BUMP_VERSION__
	 */
	protected $defaultPageTitle = 'COM_CUSTOMER_DEFAULT_PAGE_TITLE';
	...
	protected function prepareDocument()
	{
		...
		if ($menu && (!isset($menu->query['option']) || $menu->query['option'] != $this->extension || $menu->query['view'] == $this->viewName
			...
			while ((!isset($menu->query['option']) || $menu->query['option'] !== 'com_vmmdatabase' || $menu->query['view'] === 'customer'
